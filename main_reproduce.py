...
if __name__ == "__main__":
    ...
    for seed in [0,1,2,3,4]:
        ...
        # Define save path
        log_path = 'save/log/trainlog_{}_{}_{}.txt'.format(configs.model_name, configs.dataset, configs.seq_len)
        model_save_path = 'save/model/{}_{}_{}.pth'.format(configs.model_name, configs.dataset, configs.seq_len)
        result_path = 'save/result/{}_{}_{}.csv'.format(configs.model_name, configs.dataset, configs.seq_len)
